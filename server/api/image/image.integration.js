...
describe('Image API:', function() {
  ...
  describe('PUT /api/images/:id', function() {
    ...
    it('should respond with the original image', function() {
      updatedImage.name.should.equal('New Image');
      updatedImage.info.should.equal('This is the brand new image!!!');
    });
    ...
    it('should respond with the updated image on a subsequent GET', function(done) {
      request(app)
        ...
        .end((err, res) => {
          ...
          image.name.should.equal('Updated Image');
          image.info.should.equal('This is the updated image!!!');
  ...
  describe('PATCH /api/images/:id', function() {
    ...
    it('should respond with the patched image', function() {
      patchedImage.name.should.equal('Patched Image');
      patchedImage.info.should.equal('This is the patched image!!!');
    });
  });
